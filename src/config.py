...
class Config:
    ...
    email_sender_name: str = "RuyiDailyStockAnalysis金股助手"  # 发件人显示名称
    ...
    def _load_from_env(cls) -> 'Config':
        ...
        return cls(
            ...
            email_sender_name=os.getenv('EMAIL_SENDER_NAME', 'RuyiDailyStockAnalysis金股助手'),
