...
const BUTTON_VARIANT_STYLES = {
  primary: 'border border-primary/30 bg-primary-gradient text-primary-foreground shadow-lg shadow-primary/20 hover:brightness-105',
  ...
  gradient: 'border border-primary/20 bg-gradient-to-r from-primary to-purple text-primary-foreground shadow-lg shadow-primary/20 hover:brightness-105',
  ...
  return (
    <button
      ...
      className={cn(
        ...
        'focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-primary/15 focus-visible:ring-offset-0',
